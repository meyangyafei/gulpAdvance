...
var webserver = require('gulp-webserver');//webserver服务器
var url = require('url');//url地址
var fs = require('fs');//filseSystem
var sass = require('gulp-sass');//sass模块
var minifyCSS=require('gulp-minify-css');//css压缩
var uglify=require('gulp-uglify');//丑化操作
...
//将images整个目录复制到dist下的images目录，包含images写的子目录以及目录里的图片
